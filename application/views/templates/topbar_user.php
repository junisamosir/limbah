  ...
  <div class="container ">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('tentang_user'); ?>">TENTANG</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('artikel_user'); ?>">ARTIKEL</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('jadwal_user'); ?>">JADWAL</a>
        </li>
         <li class="nav-item">
          <a class="nav-link" href="<?= base_url('kontak_user'); ?>">KONTAK</a>
        </li>
        <li class="nav-item">
