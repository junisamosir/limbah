    ...
    <div class="row justify-content-center">
       <div class="col-md-5">
          <div class="form-group mt-5 pt-5">
               ...
               <h1 class="h4 mb-4 mt-4 text-center">UbahProfil</h1>
               ...
               <h1 class="h4 mb-4 mt-4 text-center">Ubah Password</h1>
               		...
               		<form action="<?= base_url('user/ubah_password'); ?>" method="post">
						...
						<div class="form-group">
			                ...
			                <input type="password" class="form-control form-control-sm form-control-user" id="password_baru1" placeholder="*minimal 6 karakter" name="password_baru1">
			                <!-- Pesan eror -->
						...
						<div class="form-group">
			                ...
			                <input type="password" class="form-control form-control-sm form-control-user" id="password_baru2" name="password_baru2">
			                <!-- Pesan eror -->
